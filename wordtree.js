        ...
        t || url({ prefix: (t = tokens[0].token) }),
            ...
            treeG.call(
                ...
                .sort(
                    ...
                    function(e, t) {
                        return (
                            t.count - e.count || e.index - t.index
                        );
                    }
                )
...
function hideHelp() {
    d3.selectAll("#help-window, #form-source").style("display", "none"),
        d3
        .selectAll("#form, #reverse-wrapper")
    ...
    page.attr(
        ...
        (e.y = Math.max(
            ...
            Math.min(
                ...
                height *
                this.scrollTop /
                (textViewer.rowHeight() * lines.length)
            )
        ))
    );
}
    ...
    function t() {
        ...
        function p(e, t) {
            ...
            if (r) {
                if (1 === r) {
                    var i = e.children[0];
                    return (
                        (L ? e.tokens.unshift : e.tokens.push).apply(
                            e.tokens,
                            i.tokens
                        ),
        ...
        function g(e) {
            if (L)
                ...
                for (
                    var t = e.tokens[e.tokens.length - 1].index, n = t + H;
        ...
        function m(e, t) {
            e.count * t < 5 ?
                e.children &&
                e.children.length > 1 &&
                ((e._collapsed = e.children),
                    (e.children = [e.children[0]])) :
                e._collapsed &&
                !e._children &&
                (e.children = e._collapsed),
                e.children &&
                e.children.forEach(function(e) {
                    m(e, t);
                });
        ...
        var y,
            ...
            .source(function(e) {
                return {
                    y: e.source.x +
                        (e.source.length ? e.source.length + T : 0),
                    x: e.source.y
                };
            })
            .target(function(e) {
        ...
        return (
            ...
            (e.width = function(t) {
                return arguments.length ?
                    (j.size([j.size()[0], (y = +t)]), e) :
                    y;
            }),
            (e.height = function(t) {
                return arguments.length ?
                    (j.size([(k = +t), j.size()[1]]), e) :
                    k;
            }),
...
var width,
    height,
    tree = wordtree().on("prefix", function(e) {
        text.call(textViewer);
...
d3.select("#paste-go").on("click", function() {
    url((state = { source: "" }), !0),
        ...
        d3
        .text("save")
        .post(d3.select("#paste").property("value"), function(e, t) {
            e
                ?
                alert(
